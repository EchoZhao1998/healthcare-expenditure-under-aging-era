...
**Overview**
This project examines how population aging influences the composition of healthcare financing, rather than total healthcare spending. Using country-level panel data from the World Bank and the WHO Global Health Expenditure Database (GHED), the analysis explores whether aging societies systematically shift healthcare costs away from households toward collective financing mechanisms such as government funding and health insurance.
...
**Outputs**
	...
	•	Public-facing article (Medium / WeChat)
